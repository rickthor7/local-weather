$(document).ready(function() {
	...
	var weatherQuotes ={
		rain: "\Allahumma Shoyyiban Nafian",
		clearDay: "\"Cuacanya terang, seterang hatimu😊",
		clearNight: "\"jangan lupa qiyamul lail. Disitulah para Malaikat mengaminkan doa doamu.\" -Rickthorism",
		snow: "\"Adem adem enake .....\" -wkwk",
		sleet: "\"Inpone anget anget gaes.\" -hahaha",
		wind: "\"Angin adalah slah 1 makhluk Allah yang senantiasa bertasbih.\" -Subhanallah",
		fog: "\"Hati hati dijalan (musiiik)",
		cloudy: "\"Kebahagiaan itu seperti awan, jika Anda menatapnya cukup lama, ia akan menguap.\" -Rickthorism",
		partlyCloudy: "\"Cobalah untuk menjadi pelangi di awan seseorang.\" -Assek",
		default: "\"Subhanallah Walhamdulillah Wala Ilaha Illallah Allahuakbar.\"― 🥳 "
	};
